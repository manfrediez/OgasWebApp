...
@Component({
  ...
  imports: [RouterLink],
  template: `
    <nav class="navbar-glass text-primary-700 px-4 py-3 flex items-center justify-between relative z-10">
      ...
      @if (auth.currentUser(); as user) {
        <div class="flex items-center gap-2 md:gap-4">
          <button (click)="goToMessages()" class="relative p-1.5 rounded-lg hover:bg-primary-50 text-primary-500 border border-transparent hover:border-primary-200 transition-all">
